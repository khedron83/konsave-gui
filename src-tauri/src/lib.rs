...
#[tauri::command]
async fn sync_push(url: String, username: String, password: String, verify_ssl: bool) -> Result<u32, String> {
    konsave::sync_push(&url, &username, &password, verify_ssl).await
}

#[tauri::command]
async fn sync_pull(url: String, username: String, password: String, verify_ssl: bool) -> Result<u32, String> {
    konsave::sync_pull(&url, &username, &password, verify_ssl).await
}
